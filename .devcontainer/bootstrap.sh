...
[ -f "${DEVENV_ROOT}/.devcontainer/env-vars.sh" ] && source "${DEVENV_ROOT}/.devcontainer/env-vars.sh"
[ -f "${DEVENV_ROOT}/.devcontainer/bash-functions.sh" ] && source "${DEVENV_ROOT}/.devcontainer/bash-functions.sh"

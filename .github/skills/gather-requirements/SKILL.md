...
- Requirements already exist → [`/plan-from-spec`](../plan-from-spec/SKILL.md) or [`/create-implementation-plan`](../create-implementation-plan/SKILL.md)
...
- [`/plan-from-spec`](../plan-from-spec/SKILL.md) — generate a detailed implementation plan from a specific requirement or phase
- [`/create-implementation-plan`](../create-implementation-plan/SKILL.md) — interview-driven planning for a specific requirement or phase

...
If you want to open a PR, use `/open-pr`. To review the code yourself, use `/code-review`. For CI failures on an open PR, fix them directly — this skill is for reviewer comments.

...
If the analysis shows the **majority** of tasks are high-impact, recommend running `/devenv-pair` instead — say so plainly. Don't try to force-fit delegation just because the user asked for it.

...
| `/devenv-refine-blueprint` | Revise an existing durable `Blueprint-*.md` while preserving structure and numbering; cascade mode co-edits specifications | Blueprint file path or upstream-impact issue number(s) |

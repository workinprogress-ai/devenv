...
Load this protocol on-demand when a design skill (/devenv-design, grooming) is given a plan file or issue as input, or when refine-plan detects architectural issues in an escalation handoff.
